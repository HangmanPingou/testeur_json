...
class testeur_json(QMainWindow): 
    def __init__(self):
        ...
        self.lb_presentation.setStyleSheet("font-size: 17px ; background: #E1F1D5 ; font-style: italic ; font-weight: bold")
        ...
        self.cbb_fichier_teste.setStyleSheet("font-size: 17px ; font-weight: bold")
        ...
        self.btn_tester.setStyleSheet("background-color: blue ; border: 2px solid black ; border-radius: 75px 20px; font-size: 17px ; font-weight: bold")
        ...
        self.lb_resultat.setStyleSheet("background: #E35CF1")
        self.lb_resultat.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.lb_resultat.setStyleSheet("font-size: 17px ; background: #E1F1D5 ; font-style: italic ; font-weight: bold")
    ...
    def test(self): # Méthode qui test la validité du fichier.
        ...
        if fichier == "Choisir le fichier : ": # Si aucun choix n'est fait dans le comboBox
            self.lb_resultat.setStyleSheet("font-size: 17px ; color: black ; font-style: italic ; font-weight: bold")
            ...
            try:
                with open(f"test/{fichier}", "r") as f: # J'ouvre le fichier dans le TRY. Si ça fonctionne le fichier est valide.
                    essai = json.load(f)
                    f.close()
                self.lb_resultat.setStyleSheet("font-size: 17px ; color: green ; font-style: italic ; font-weight: bold")
                self.lb_resultat.setText("Le fichier est valide")
            except: # Sinon le fichier est invalide.
                self.lb_resultat.setStyleSheet("font-size: 17px ; color: red ; font-style: italic ; font-weight: bold")
